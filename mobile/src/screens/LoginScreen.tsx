...
export function LoginScreen({ navigation }: Props) {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', padding: 24, backgroundColor: '#131313' }}>
      <Text style={{ color: '#a58b84', letterSpacing: 2, fontSize: 10 }}>AUTH_PROTOCOL // OPS</Text>
      <Text style={{ color: '#e5e2e1', fontSize: 28, marginTop: 8 }}>Kılıç Coffee</Text>
      <Pressable
      ...
      <Pressable onPress={() => navigation.replace('Shop')} style={{ marginTop: 20 }}>
        <Text style={{ color: '#a58b84', textAlign: 'center' }}>Mağazaya dön</Text>
      </Pressable>
    </View>
  );
}
