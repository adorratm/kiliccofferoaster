...
ARG AWS_CDN_URL=
ARG NEXT_PUBLIC_DOWNLOAD_WINDOWS=/downloads/KilicCoffeeRoaster-Setup.exe
ARG NEXT_PUBLIC_DOWNLOAD_MAC=
...
ENV NEXT_PUBLIC_DOWNLOAD_MAC=$NEXT_PUBLIC_DOWNLOAD_MAC
