...
const NAV = [
  ...
  { href: '/icerik', label: 'İçerik', code: '04' },
  { href: '/site-ayarlari', label: 'Site Ayarları', code: '05' },
  { href: '/medya', label: 'Medya', code: '06' },
  { href: '/siparisler', label: 'Siparişler', code: '07' },
  { href: '/kargo', label: 'Kargo', code: '08' },
  { href: '/pazaryeri', label: 'Pazaryeri', code: '09' },
  { href: '/sozlesmeler', label: 'Sözleşmeler', code: '10' },
  { href: '/mesajlar', label: 'Mesajlar', code: '11' },
  { href: '/bulten', label: 'Bülten', code: '12' },
  { href: '/kuyruklar', label: 'Kuyruklar', code: '13' },
];
